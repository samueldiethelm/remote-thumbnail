...
add_filter('post_thumbnail_html', 'remote_post_thumbnail_html', 11, 5);
function remote_post_thumbnail_html($html, $post_ID, $post_image_id, $size, $attr){
...
//return a value when checking if post has thumbnail. Use -1 which will not match any existing post_id
add_filter( "get_post_metadata" , "return_false_thumbnail_id",10,4);
function return_false_thumbnail_id($value, $object_id, $meta_key, $single ){
